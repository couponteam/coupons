...
public class PhoneUtil {
     ...
     * @return
     */
    public boolean checkMultiPhone(String input){
     ...
     * @return
     */
    public boolean isPhoneOrTel(String input){
     ...
     * @return 返回true,否则为false
     */
    public boolean isChinaUnicomPhoneNum(String str) {
     ...
     * @return 返回true,否则为false
     */
    public boolean isChinaMobilePhoneNum(String str) {
